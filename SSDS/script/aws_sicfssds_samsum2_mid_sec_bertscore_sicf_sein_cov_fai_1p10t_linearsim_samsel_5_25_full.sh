...
unc_save_prefix="newSAMSUM2_1p10t_full_bnn_mean_dp_select_linearrank_aws" # using new cov by POS
...
python SSDS_main.py \
    --model_name_or_path Models/newSAMSUM2_DialogLED_base_SSDS_max_800_maxlen_96_min5_merge_cluster_ori/ck_best \
    --do_train False \
    --do_eval False \
    --do_predict False \
